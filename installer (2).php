...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220618_travelmania_9f3be176c112e9cb2053_20220618112732_archive.zip';
	const ARCHIVE_SIZE		 = '97260134';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '9f3be17-18112732';
    const SECONDARY_PACKAGE_HASH = 'b8a14de-18112732';
	const VERSION			 = '1.4.6';
